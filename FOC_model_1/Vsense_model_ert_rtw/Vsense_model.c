...
void Vsense_model_initialize(void)
{
  ...
  /* External mode info */
  Vsense_model_M->Sizes.checksums[0] = (901101613U);
  Vsense_model_M->Sizes.checksums[1] = (1913430238U);
  Vsense_model_M->Sizes.checksums[2] = (2925949284U);
  Vsense_model_M->Sizes.checksums[3] = (3722258693U);
