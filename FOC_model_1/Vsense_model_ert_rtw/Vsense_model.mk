###########################################################################
## Makefile generated for component 'Vsense_model'. 
## 
## Makefile     : Vsense_model.mk
## Generated on : Sat May 16 12:18:39 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Vsense_model.elf
...
COMPILER_COMMAND_FILE     = Vsense_model_comp.rsp
CMD_FILE                  = Vsense_model.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Vsense_model.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DUSE_FULL_LL_DRIVER -DSTM32F405xx -DUSE_HAL_DRIVER -DMW_TIMEBASESOURCE=TIM1 -DMW_CONNECTIVITY_UART=UART4_BASE -DMW_CONNECTIVITY_RX_DMA=DMA1 -DMW_UART4_RX_DMA_STREAM=2 -DMW_UART4_RX_DMA_ENABLED=DMA1_Stream2_IRQHandler -DMW_CONNECTIVITY_RX_DMAStream=LL_DMA_STREAM_2 -DMW_UART4_TX_DMA_STREAM=4 -DMW_CONNECTIVITY_TX_DMA=DMA1 -DMW_UART4_TX_DMA_ENABLED=DMA1_Stream4_IRQHandler -DMW_CONNECTIVITY_TX_DMAStream=LL_DMA_STREAM_4 -DMW_CONNECTIVITY_TX_BUFFER=GET_UART4_TRANSMIT_BUFFER -DMW_UART4_TRANSMIT_BUFFER_SIZE=1024 -DMW_CONNECTIVITY_RX_BUFFER=GET_UART4_RECEIVE_BUFFER -DMW_UART4_RECEIVE_BUFFER_SIZE=1024 -DMW_UART4_ENABLED=1 -DMW_GPIO_BIT_SHIFT=0
...
DEFINES_STANDARD = -DMODEL=Vsense_model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_mode.c $(START_DIR)/Vsense_model_ert_rtw/Vsense_model.c $(START_DIR)/Vsense_model_ert_rtw/Vsense_model_data.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_common.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_classic_trigger.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_standard.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_daq.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_calibration.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_fifo.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_transport.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_mem_default.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_drv_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common/xcp_utils.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_frame_serial.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_param_default_serial.c C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/shared/supportpackages/stm32/src/overrideHALDelay.c C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/shared/supportpackages/stm32/src/platform_timer.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/SysTickScheduler.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/m3m4m4f_multitasking.c C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/shared/supportpackages/stm32/src/rtiostream_serial.c C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/shared/supportpackages/stm32/src/stm_usart.c C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/shared/supportpackages/stm32/src/sys_arch_arm.c D:/Harini/Matlab/F405_Vsense/Core/Src/main.c D:/Harini/Matlab/F405_Vsense/Core/Src/stm32f4xx_it.c D:/Harini/Matlab/F405_Vsense/Core/Src/stm32f4xx_hal_msp.c D:/Harini/Matlab/F405_Vsense/Core/Src/stm32f4xx_hal_timebase_tim.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_gpio.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_adc.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ex.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ramfunc.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma_ex.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_cortex.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c D:/Harini/Matlab/F405_Vsense/Core/Src/system_stm32f4xx.c D:/Harini/Matlab/F405_Vsense/STM32CubeIDE/Application/User/Core/syscalls.c D:/Harini/Matlab/F405_Vsense/STM32CubeIDE/Application/User/Core/sysmem.c D:/Harini/Matlab/F405_Vsense/STM32CubeIDE/Application/User/Startup/startup_stm32f405rgtx.s C:/ProgramData/MATLAB/SupportPackages/R2025b/toolbox/shared/supportpackages/stm32/src/stm_adc_ll.c

MAIN_SRC = $(START_DIR)/Vsense_model_ert_rtw/ert_main.c
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "D:\Harini\Matlab\F405_Vsense\STM32CubeIDE\STM32F405RGTX_FLASH.ld" --specs=nano.specs
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "D:\Harini\Matlab\F405_Vsense\STM32CubeIDE\STM32F405RGTX_FLASH.ld" --specs=nano.specs
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "D:\Harini\Matlab\F405_Vsense\STM32CubeIDE\STM32F405RGTX_FLASH.ld" --specs=nano.specs
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T "D:\Harini\Matlab\F405_Vsense\STM32CubeIDE\STM32F405RGTX_FLASH.ld" --specs=nano.specs
...
%.c.o : $(START_DIR)/Vsense_model_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Vsense_model_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/Vsense_model_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Vsense_model_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Vsense_model_ert_rtw/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Vsense_model_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Vsense_model.c.o : $(START_DIR)/Vsense_model_ert_rtw/Vsense_model.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Vsense_model_data.c.o : $(START_DIR)/Vsense_model_ert_rtw/Vsense_model_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/Vsense_model_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
main.c.o : D:/Harini/Matlab/F405_Vsense/Core/Src/main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_it.c.o : D:/Harini/Matlab/F405_Vsense/Core/Src/stm32f4xx_it.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_msp.c.o : D:/Harini/Matlab/F405_Vsense/Core/Src/stm32f4xx_hal_msp.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_timebase_tim.c.o : D:/Harini/Matlab/F405_Vsense/Core/Src/stm32f4xx_hal_timebase_tim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_tim.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_tim_ex.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_tim_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_ll_gpio.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_gpio.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_ll_adc.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_adc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_ll_dma.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_dma.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_ll_rcc.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_rcc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_ll_utils.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_utils.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_ll_exti.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_exti.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_rcc.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_rcc_ex.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_rcc_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_flash.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_flash_ex.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_flash_ramfunc.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_flash_ramfunc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_gpio.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_gpio.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_dma_ex.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_dma.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dma.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_pwr.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_pwr_ex.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_pwr_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_cortex.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_cortex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_hal_exti.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_exti.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32f4xx_ll_usart.c.o : D:/Harini/Matlab/F405_Vsense/Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_ll_usart.c
	$(CC) $(CFLAGS) -o "$@" "$<"


system_stm32f4xx.c.o : D:/Harini/Matlab/F405_Vsense/Core/Src/system_stm32f4xx.c
	$(CC) $(CFLAGS) -o "$@" "$<"


syscalls.c.o : D:/Harini/Matlab/F405_Vsense/STM32CubeIDE/Application/User/Core/syscalls.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sysmem.c.o : D:/Harini/Matlab/F405_Vsense/STM32CubeIDE/Application/User/Core/sysmem.c
	$(CC) $(CFLAGS) -o "$@" "$<"


startup_stm32f405rgtx.s.o : D:/Harini/Matlab/F405_Vsense/STM32CubeIDE/Application/User/Startup/startup_stm32f405rgtx.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
